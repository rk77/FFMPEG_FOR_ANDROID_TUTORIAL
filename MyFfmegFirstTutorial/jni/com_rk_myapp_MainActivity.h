 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_rk_myapp_MainActivity_nativeSetSurface
  (JNIEnv *, jobject);
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_rk_myapp_MainActivity_nativeGetFrameBitmap
  (JNIEnv *, jobject, jint);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_rk_myapp_MainActivity_nativePause
  (JNIEnv *, jobject);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_rk_myapp_MainActivity_nativePlay
  (JNIEnv *, jobject);
